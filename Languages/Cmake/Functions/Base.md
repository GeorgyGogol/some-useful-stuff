...
Почему я ставлю именно 3.15 во время существования 3.31.2 - я не знаю. Возможно, чтобы обеспечить обратную совместимость с машинами, на которых CMake не обновлен, а возможно потому что левая пятка так зачесалась. На вкус и цвет...
...
Для путей включения могут быть использованы разные интерфейсы путей.
...
В дальнейшем, в зависимости от выполняемой команды, будут подставлены нужные пути (для сборки или установки).
...
4. Созданные в поддиректории переменные остаются в поддиректории

...
Наглядно, файл имеет примерно такое содержимое:
...
Тривиальный файл для тривиального, цельного проекта (без зависимостей или зависимых модулей), находящегося в одной директории с исходным кодом. Сойдет для начала и (частично) для небольших приложений, но не подойдет для модулей в связи с тем, что для модулей нужно позаботиться об интерфейсах интеграции (установки) с целевыми проектами (клиентскими).

...
CMake предоставляет возможность производить установку пакета и использовать его различными таргетами. Подключение, как правило, происходит с помощью команды [find_package()](../Modules.md#find_package).
...
1. Сам проект модуля
2. Публичный API модуля (заголовочные файлы для включения в других проектах)
3. Этап разработки - написать скопилированную рабочую часть

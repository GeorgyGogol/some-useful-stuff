...
Следующий шаг после сборки - установка приложения.
...
Заклинание выполнит установку скомпилированного проекта по заданым настройкам. Фактически, как правило, - переместит юниты, заголовочные файлы и cmake-файлы для дальнейшего использования другими проектами (или пользователем).

Подробнее почитать вот [тут](Commands/Install.md)
